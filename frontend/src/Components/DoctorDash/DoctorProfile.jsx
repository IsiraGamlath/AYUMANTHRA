...
import Sidebar from "../Nav/DocNav/DNav";
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-3xl mx-auto transition transform hover:scale-[1.01] space-y-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 border-b pb-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <FaBell onClick={() => navigate("/doctor-notifications")} className="text-gray-600 hover:text-gray-800 text-3xl cursor-pointer transition" title="Notifications" />
            </div>
          </div>
