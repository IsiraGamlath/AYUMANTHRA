...
import DoctorNotification from '../model/doctorNotificationModel.js'; // Add this import
import { createBookingReminderMessage } from './smsService.js';
...
const sendDoctorAppointmentReminder = async (appointment, reminderType = '1day') => {
  try {
    ...
    const Doctor = (await import('../model/doctorModel.js')).default;
    ...
    // For now, we'll just log the reminder for the doctor
    // In a real implementation, this would send an email or SMS to the doctor
 ...
 */
export const send2HourReminders = async () => {
  try {
 ...
 * @returns {Promise<Object>} - Summary of 2-hour reminders sent
 */
export const trigger2HourReminders = async () => {
