const { createBookingConfirmationMessage, createCancellationMessage, createRescheduleMessage } = require('./smsService');
 ...
 * @returns {Promise<boolean>} - Success status
 */
const sendRescheduleNotification = async (appointment, oldDate, oldTime) => {
  try {
